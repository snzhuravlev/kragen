...
from kragen.api.deps import AdminUserId
...
@router.get("")
async def list_plugins(admin_id: AdminUserId) -> dict[str, Any]:
...
async def get_plugin(plugin_id: str, admin_id: AdminUserId) -> dict[str, Any]:
...
async def enable_plugin(plugin_id: str, admin_id: AdminUserId) -> dict[str, Any]:
...
async def disable_plugin(plugin_id: str, admin_id: AdminUserId) -> dict[str, Any]:
